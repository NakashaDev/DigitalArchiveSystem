...
return [
    ...
    */
    ...
    'password' => [
        ...
        'mixedNumbers' => 'The :attribute must contain at least one uppercase, one lowercase letter and one number.',
        'mixedSymbols' => 'The :attribute must contain at least one uppercase, one lowercase letter and one symbol.',
        'numbersSymbols' => 'The :attribute must contain at least one number and one symbol.',
        'all' => 'The :attribute must contain at least one uppercase, one lowercase letter, one number and one symbol.',
