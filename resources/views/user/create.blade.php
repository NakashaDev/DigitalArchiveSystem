                        ...
                        <div class="card border-none shadow-none">
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{old('name')}}" id="text-input-name">
                                        @error('name')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" value="{{old('email')}}" id="text-input-email">
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        ...
                                        <div class="d-flex align-items-center gap-4 @error('group') is-invalid @enderror">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="group-{{ $groupId }}"
                                                       name="group" value="{{ $groupId }}" {{ old('group') == $groupId ? 'checked' : '' }}>
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-sm-10">
                                        <div class="d-flex align-items-center gap-4">
                                            <button type="submit" class="btn btn-primary w-md">登録</button>
                                            <button type="reset" class="btn btn-light w-md">リセット</button>
                                        </div>
                                    </div><!-- end col -->
                                </div>
