...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form id="form-genre-create" method="POST" action="{{route('genre.update', ['id'=>$id])}}">
                @method('put')
                @csrf
                <div class="card">
                    ...
                    <div class="card-body text-end">
                        ...
                        <input class="form-control" type="text" readonly value="{{$record['code']}}" name="code">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-5">
                            ...
                            <a href="{{route('genre.index')}}" class="btn btn-secondary">戻る</a>
                        </div>
                    </div>
                    <!-- end card body -->
                </div>
